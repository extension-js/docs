...
<PackageManagerTabs
  command={{
    npm: "npx extension@latest dev @Extension/templates/css-modules",
    pnpm: "pnpx extension@latest dev @Extension/templates/css-modules",
    yarn: "yarn dlx extension@latest dev @Extension/templates/css-modules",
  }}
/>
## Usage With An Existing Extension{" "}

`Extension` offers zero-config CSS modules support. To enable CSS Modules for a CSS file, just rename it to include `.module.css`.
...
export default function NewTabPage() {
  return <button className={buttonStyles.primary}>Click here</button>;
}
```
