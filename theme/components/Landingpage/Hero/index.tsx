...
const Hero = memo(() => {
  ...
  return (
    <header className="max-w-[1280px] px-6 m-auto grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-12 md:pb-24">
      ...
      <div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <div className="grid h-12 w-full grid-cols-2 items-center justify-center gap-6">
            <button
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[--rp-c-brand] text-[--btn-text] shadow hover:[--rp-c-brand]/90 px-4 py-2 h-12"
              type="button"
            ...
            >
              ...
              <div className="flex items-center">
                <svg
                  ...
                  className="lucide lucide-play ml-2 size-4 fill-[--btn-text] stroke-[--btn-text]"
                >
                ...
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="lucide lucide-play -ml-1 size-4 fill-[--btn-text] stroke-[--btn-text]"
                >
                  <title>Arrow right</title>
                  <polygon points="6 3 20 12 6 21 6 3" />
                </svg>
