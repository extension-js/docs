...
const ANNOUNCEMENT_URL = "/blog/announcing-2-0-0-alpha";
  ...
  return (
    ...
    >
      <a
        ...
        className="hover:underline text-sm flex items-center text-background"
      >
        <span>
          {lang === "en"
      ...
      <button
        ...
        className="absolute right-6 p-2 cursor-pointer text-sm hover:bg-[rgba(255,255,255,0.3)] rounded-full"
      >
        <CloseIcon />
      </button>
    </div>
